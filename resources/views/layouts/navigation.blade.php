<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                @hasrole('Admin')
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-nav-link :href="route('tindakans.index')" :active="request()->routeIs('tindakans.index')">
                                {{ __('Tindakan') }}
                            </x-nav-link>
                        </div>
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        @hasrole('Admin')
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('tindakans.index')" :active="request()->routeIs('tindakans.index')">
                    {{ __('Tindakan') }}
                </x-responsive-nav-link>
            </div>
