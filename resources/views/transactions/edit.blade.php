                                    ...
                                    <select
                                        ...
                                        @foreach ($data as $pasien)
                                            <option value="{{ $pasien->id }}"
                                                @if ($pasien->id == $transaction->pasien_id) selected @endif>{{ $pasien->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <select
                                        ...
                                        @foreach ($obats as $obat)
                                            <option value="{{ $obat->id }}"
                                                @if ($obat->id == $transaction->obat_id) selected @endif>{{ $obat->kode }} /
                                                {{ $obat->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($tindakans as $tindakan)
                                            <option value="{{ $tindakan->id }}" @if ($tindakan->id == $transaction->tindakan_id) selected @endif>{{ $tindakan->name }} /
                                                {{ $tindakan->category }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
